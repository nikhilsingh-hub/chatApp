...
overflow: hidden;
box-shadow: rgba(245,213,133, 0.25) 0px 54px 55px, rgba(245,213,133, 0.12) 0px -12px 30px, rgba(245,213,133, 0.12) 0px 4px 6px, rgba(245,213,133, 0.17) 0px 12px 13px, rgba(245,213,133, 0.09) 0px -3px 5px;
...
.brand {
  ...
  background: linear-gradient(to right, #2c56d7, #ff9000);
  img {
    height: 2rem;
  }
  h3 {
